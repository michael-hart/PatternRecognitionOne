...
% one_v_one_svm_raw_scaled = multi_class_svm(training_scaled', l_train, svmtrainpref);
% one_v_one_svm_pca = multi_class_svm(faces_coeff_training, l_train, svmtrainpref);
% one_v_one_svm_pca_scaled = multi_class_svm(faces_coeff_training_scaled, l_train, svmtrainpref);
